...
payload = {'user_id': 1, 'session_id': session_id, 'message': 'Call the google_workspace__manage_accounts tool with arguments: {\"operation\": \"authenticate\"} to begin auth flow.'}
